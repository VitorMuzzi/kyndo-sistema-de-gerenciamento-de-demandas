...
O Kyndo é um sistema full-stack de gerenciamento de tarefas estruturado na metodologia Kanban. O projeto foi desenvolvido para atender demandas de controle interno, com foco em usabilidade, performance e segurança de dados.
...
Quadro Kanban com sistema de drag and drop.
...
Automação de fluxo: colunas podem ser configuradas para alterar o status da demanda automaticamente (ex: mover para "concluído" ao finalizar o checklist).
...
Backend: Python 3, FastAPI, SQLAlchemy, SQLite, Bcrypt, PyJWT.
